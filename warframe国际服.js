...
export class warframe extends plugin {
    constructor() {
        super({
            ...
            rule: [{
                /** 命令正则匹配 */
                reg: '#wfihelp|wfihelp|wfi菜单', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'menu'
            }, {
                /** 命令正则匹配 */
                reg: '#alerts信息', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceAlerts'
            }, {
                /** 命令正则匹配 */
                reg: '#wfi新闻(.*)', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceNews'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi赛特斯(.*)|wfi地球平原|wfi平原时间', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceCetus'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi地球时间|#地球外景时间', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceEarth'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi索拉里斯(.*)|#wfi金星平原|wfi金星平原', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceSolaris'
            },
            {
                /** 命令正则匹配 */
                reg: '#earth赏金', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getEarthBounty'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi金星赏金(.*)|wfi金星平原赏金|#金星赏金', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getSolarisBounty'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi火卫二赏金(.*)|wfi火卫二平原赏金|#火卫二赏金', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getEntratiSyndicateBounty'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi裂隙(.*)|wfi裂隙信息', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceFissures'
            },
            {
                /** 命令正则匹配 */
                reg: 'wfi奸商(.*)', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceTrader'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi突击(.*)|wfi突击信息|wfi今日突击', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceSortie'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi每日优惠(.*)', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceDailyDeals'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi入侵(.*)', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceInvasions'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi事件(.*)|热美亚|尸鬼', //匹配消息正则,命令正则
                /** 执行方法 */
                fnc: 'getInternationalServiceEvents'
            },
            {
                /** 命令正则匹配 */
                reg: '#wfi电波(.*)|wfi电波|wfi电波任务', //匹配消息正则,命令正则
                /** 执行方法 */
